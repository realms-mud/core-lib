...
void Setup()
{
    ResearchItem = clone_object("/lib/tests/support/research/testPersistedRitualResearchItem");
    ResearchItem->init();
...
void AddSpecificationDoesNotAllowInvalidModifierToBeSet()
{
    ...
    string expectedError = "*ERROR - persistedRitualResearchItem: the 'modifier' specification must be a properly formatted modifier.\n";
...
void ExecuteOnSelfAppliesRitualBonusWhenRitualCompleted()
{
    ...
    ExpectTrue(ResearchItem->testAddSpecification("bonus long sword", 10));
    ExpectTrue(ResearchItem->testAddSpecification("bonus magical attack", 10));
    ExpectTrue(ResearchItem->testAddSpecification("bonus weapon attack", 1));
    ExpectTrue(ResearchItem->testAddSpecification("duration", 10));
...
/////////////////////////////////////////////////////////////////////////////
void ExecuteOnTargetWithRitualAppliesNegativeEffect()
{
    ResearchItem->TogglePerformRitual();
    ExpectTrue(ResearchItem->testAddSpecification("penalty to long sword", 4));
    ExpectTrue(ResearchItem->testAddSpecification("duration", 10));
...
/////////////////////////////////////////////////////////////////////////////
void NegativeExecuteInAreaWithRitualAppliedOnCorrectTargets()
{
    ResearchItem->TogglePerformRitual();
    ...
    ExpectTrue(ResearchItem->testAddSpecification("penalty to long sword", 2));
    ExpectTrue(ResearchItem->testAddSpecification("duration", 10));
