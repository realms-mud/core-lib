...
void TransferMoneyRemovesMoneyAndReturnsMoneyObjectOfRemovedValue()
{
    ...
    ExpectEq("obj/money.c", program_name(money), "A money object was created");
    ExpectEq(250, money->query_value(), "money object has a value of 250");
...
/////////////////////////////////////////////////////////////////////////////
void add_weightCorrectlyAddsWeight()
{
    Inventory->Str(3);
    ExpectFalse(Inventory->add_weight(20), "Cannot add more than twice your strength + 10");
    Inventory->Str(10);
    ExpectTrue(Inventory->add_weight(20), "Can add less than twice your strength + 10");
}
