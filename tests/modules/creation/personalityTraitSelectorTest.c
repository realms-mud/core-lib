...
void InitialCreationDisplayIsCorrect()
{
    ...
    ExpectEq("[0;36mCharacter creation - [0m[0;37;1mPersonality Test[0m\n\n"
        ...
        "\t[[0;31m1[0m] - [0;32mExcite and energize you. This is, after all, your element and you\n"
        "\t      love meeting new people.\n[0m\n"
        "\t[[0;31m2[0m] - [0;32mFill you with a sense of dread. People suck and you really would\n"
...
void SecondQuestionIsCorrect()
{
    ...
    ExpectEq("[0;36mCharacter creation - [0m[0;37;1mPersonality Test[0m\n\n"
        ...
        "\t[[0;31m1[0m] - [0;32mGet on with it. If you hurry up and work through the problem as\n"
        "\t      convention dictates, it shouldn't take too long ere you're done\n"
        "\t      and able to move on to more enjoyable activities.\n[0m\n"
        "\t[[0;31m2[0m] - [0;32mReject convention. If you think about the problem for a while,\n"
...
void ThirdQuestionIsCorrect()
{
    ...
    ExpectEq("[0;36mCharacter creation - [0m[0;37;1mPersonality Test[0m\n\n"
        ...
        "\t[[0;31m1[0m] - [0;32mThoroughly discuss all of the pros and cons of both projects and\n"
        "\t      clearly detail why the well is the only logical choice.\n[0m\n"
        "\t[[0;31m2[0m] - [0;32mSeek to understand why the others want the statue and work toward\n"
...
void FourthQuestionIsCorrect()
{
    ...
    ExpectEq("[0;36mCharacter creation - [0m[0;37;1mPersonality Test[0m\n\n"
        ...
        "\t[[0;31m1[0m] - [0;32mMeticulously and methodically organize your plan of attack. You\n"
        "\t      will only get one chance, so this had best be perfect.\n[0m\n"
        "\t[[0;31m2[0m] - [0;32mPrepare for the attack with those resources you have on hand. The\n"
...
void FifthQuestionIsCorrect()
{
    ...
    ExpectEq("[0;36mCharacter creation - [0m[0;37;1mPersonality Test[0m\n\n"
        ...
        "\t[[0;31m1[0m] - [0;32mHonor your contract and bring the man to justice knowing that he\n"
        "\t      faces executioner for acting with compassion and honor in\n"
        "\t      protecting innocents.\n[0m\n"
        "\t[[0;31m2[0m] - [0;32mFree him knowing that, at best, your quest will fail and at worst,\n"
        "\t      your duplicity will be discovered.\n[0m\n"
        "\t[[0;31m3[0m] - [0;32mTake up arms against the local lord and bring him to justice\n"
        "\t      before the king, knowing full well that the king would judge his\n"
        "\t      deed the act of a criminal.\n[0m\n"
        "\t[[0;31m4[0m] - [0;32mInform the local lord that you have uncovered the true nature of\n"
...
void SixthQuestionIsCorrect()
{
    ...
    ExpectEq("[0;36mCharacter creation - [0m[0;37;1mPersonality Test[0m\n\n"
        ...
        "\t[[0;31m1[0m] - [0;32mSilently offer a toast to yourself. It appears that the treasure\n"
        "\t      really is all yours!\n[0m\n"
        "\t[[0;31m2[0m] - [0;32mTurn yourself in. If you tell the constable what happened and\n"
