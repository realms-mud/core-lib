...
/////////////////////////////////////////////////////////////////////////////
public void onJoinGuild(object caller)
{
...
/////////////////////////////////////////////////////////////////////////////
public void onAdvancedRank(object caller)
{
    raise_error("event handler: onAdvancedRank called");
}

/////////////////////////////////////////////////////////////////////////////
public void onDemotedRank(object caller)
{
    raise_error("event handler: onDemotedRank called");
}

/////////////////////////////////////////////////////////////////////////////
public void onLeaveGuild(object caller)
{
