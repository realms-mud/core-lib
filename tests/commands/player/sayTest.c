...
void HelpForSayDisplaysProperInfo()
{
    ...
    ExpectEq("\x1b[0;31m+-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-+ Help for Say +=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-+\n"
        ...
        "\t\t\x1b[0m\x1b[0;36m\x1b[0m\x1b[0;33m<Language>\x1b[0m\x1b[0;36m] [-t(arget) \x1b[0m\x1b[0;36m\x1b[0m\x1b[0;33m<Target>\x1b[0m\x1b[0;36m] \x1b[0;31;1m<Message to speak>\n"
        "\t\t\x1b[0m\x1b[0m\n"
        ...
        "\t\x1b[0m\x1b[0;32m\tYou say in complete gibberish, `Blarg nukuleve zog forgla\n"
        "\tbup'\n"
        "\t\x1b[0m\x1b[0;36mOther users would then see:\n"
        "\t\x1b[0m\x1b[0;32m\tBob says in complete gibberish, `Blarg nukuleve zog forgla\n"
        "\tbup'\n"
        ...
        "\trange and, so too, is one's ability to speak and translate it. You will\n"
        "\tgo from being able to speak/understand nothing to brokenly speaking or\n"
        "\tpartially understanding all the way through being completely fluent.\n"
        "\t\x1b[0m\x1b[0m\n"
