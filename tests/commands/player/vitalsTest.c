...
void HelpForVitalsDisplaysProperInfo()
{
    ...
    ExpectEq("[0;31m+-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=+ Help for Vitals +=-=-=-=-=-=-=-=-=-=-=-=-=-=-+\n"
        "[0m[0;36;1mSynopsis\n"
        "[0;36m	vitals - Display a character's vitals\n"
        "[0m\n"
        "[0;36;1mSyntax\n"
        "[0m	[0;36mvitals\n"
        "		[0m\n"
        "[0m[0;36;1mDescription\n"
        "[0;36mThe vitals command displays information about your current hit points, spell\n"
        "points, and stamina points levels.\n\nFor example:\n> vitals\n"
        "[0;31m|[0m  [0;36mHit Points: [0;35;1m==[0;31m........[0m"
        "[0;36m   Spell Points: [0;35;1m========[0;31m..[0m       "
        "[0;36mStamina: [0;35;1m==========[0m [0;31m|[0m\n[0;31m|"
        "              [0;33m30 / 121                    122 / 152 "
        "                96 / 96   [0;31m|[0m\n\n[0m\n"
        "[0;36;1mOptions\n"
        "[0m[0;36m\tThis command does not have any options.[0m\n\n"
        "[0;36;1mNotes\n"
        "[0;36m	See also: score\n"
        "[0m\n"
        "[0;36;1mCopyright\n"
