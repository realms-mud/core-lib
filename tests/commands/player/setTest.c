...
void PlayerHelpDisplaysCorrectly()
{
    ...
    ExpectEq("\x1b[0;31m+-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-+ Help for Set +=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-+\n"
        ...
        "\x1b[0;36m	set - Set various player-controlled game parameters.\n"
        "\x1b[0m\n"
        "\x1b[0;36;1mSyntax\n"
        "\x1b[0m	\x1b[0;36mset [-p \x1b[0;33m<Value>\x1b[0m\x1b[0;36m] [-v \x1b[0;33m<Value>\x1b[0m\x1b[0;36m]\n"
        "		\x1b[0m\n"
        "\x1b[0m\x1b[0;36;1mDescription\n"
        "\x1b[0;36mSet allows a player to set various configuration parameters for their\n"
        ...
        "\x1b[0m\n"
        "\x1b[0;36;1mOptions\n"
        "\x1b[0m    \x1b[0;36;1m[-p \x1b[0;33m<Value>\x1b[0m]\x1b[0m, \x1b[0;36;1m[-p \x1b[0;33m<Value>\x1b[0m]\n"
        "\x1b[0m\x1b[0;36m	This flag allows a user to specify the parameter they wish to set.\n"
        "	It must be used in conjunction with the -vflag. Possible parameters are:\n"
        "	\n"
        ...
        "	                       \n"
        "	\x1b[0m\n"
        "    \x1b[0;36;1m-v \x1b[0;33m<Value>\x1b[0m]\x1b[0m, \x1b[0;36;1m-v \x1b[0;33m<Value>\x1b[0m]\n"
        "\x1b[0m\x1b[0;36m	This option will set the value for the specified parameter.\n"
        "	It must be used in conjunction with the -p flag.\n"
        "	\x1b[0m\n"
        "\x1b[0;36;1mNotes\n"
        "\x1b[0;36m	See also: tell, reply, guild, and shout\n"
        "\x1b[0m\n"
