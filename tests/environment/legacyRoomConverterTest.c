...
void CanTranslateExtraMethods()
{
    ...
    ExpectEq("//*****************************************************************************\n"
        ...
        "\n"
        "    addExit(\"north\", \"/lib/legacy/maeglin/anfauglith/anf3\");\n"
        "    addExit(\"west\", \"/lib/legacy/maeglin/anfauglith/echoriath2\");\n"
        "    addExit(\"east\", \"/lib/legacy/maeglin/anfauglith/echoriath4\");\n"
        "\n"
        "    addObject(\"/lib/tests/support/services/mockNPC.c\");\n"
        "}\n"
        "\n"
...
void CanTranslateIncludedFiles()
{
    ...
    ExpectEq("//*****************************************************************************\n"
        ...
        "\n"
        "    addExit(\"north\", \"/lib/legacy/maeglin/anfauglith/anfe7\");\n"
        "    addExit(\"south\", \"/lib/legacy/maeglin/anfauglith/anfe9\");\n"
        "    addExit(\"west\", \"/lib/legacy/maeglin/anfauglith/sirion_ford\");\n"
        "\n"
        "}\n"
        "\n"
        "/////////////////////////////////////////////////////////////////////////////\n"
