...
string EndBar = "+-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-+\n";
string SkillsRow = "| %24s : %3d %5s  %24s : %3d %5s  |\n";
string HalfRow = "| %24s : %3d %5s  %38s|\n";
string SkillPoints = "You have %d skill points available to spend.\n";
