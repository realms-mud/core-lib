...
void DisplayDetailsShowCorrectInformation()
{
    ...
    ExpectEq("Research Name   : Tempest\n"
        ...
        "                  Modified -> 1.25 * your Static Charge research (multiplicative)\n"
        "                  Modified -> 1.25 * your Ionization research (multiplicative)\n"
        "                  Modified -> 1.50 * your Plasma Eruption research (multiplicative)\n"
        ...
        "                  Modified -> 1.10 * your physics skill (additive)\n"
        "                  Modified -> 1.05 * your mathematics skill (additive)\n"
        "                  Modified -> 1.05 * your chemistry skill (additive)\n"
        "                  Modified -> 1.05 * your intelligence attribute (additive)\n"
        "                  Modified -> 1.02 * your dexterity attribute (additive)\n"
        "                  Modified -> 1.02 * your wisdom attribute (additive)\n"
