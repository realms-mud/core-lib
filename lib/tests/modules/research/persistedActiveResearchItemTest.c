...
void AddSpecificationThrowsForInvalidBonuses()
{
    ...
    string expectedError = "*ERROR - persistedActiveResearchItem: the 'bonus blarg' specification must be a valid modifier as defined in /lib/services/bonusesService.c\n";
...
void AddSpecificationThrowsForInvalidPenalties()
{
    ...
    string expectedError = "*ERROR - persistedActiveResearchItem: the 'penalty to blarg' specification must be a valid modifier as defined in /lib/services/bonusesService.c\n";
...
void AddSpecificationThrowsForInvalidCombatModifiers()
{
    ...
    string expectedError = "*ERROR - persistedActiveResearchItem: the 'apply blarg' specification must be a valid modifier as defined in /lib/services/bonusesService.c\n";
