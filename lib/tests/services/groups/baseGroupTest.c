...
void Setup()
{
    Group = clone_object("/lib/tests/support/services/groups/mockGroup.c");
...
{
    destruct(Group);
    Group = clone_object("/lib/services/groups/baseGroup.c");
...
{
    destruct(Group);
    Group = clone_object("/lib/services/groups/apprentice.c");
...
{
    destruct(Group);
    Group = clone_object("/lib/services/groups/god.c");
...
{
    destruct(Group);
    Group = clone_object("/lib/services/groups/player.c");
