...
{
    ExpectTrue(Wizard.hasOwnershipAccess("/lib/services/groups"));
    ExpectTrue(Wizard.hasOwnershipAccess("/lib/tests/services/groups"));
    ExpectTrue(Wizard.hasOwnershipAccess("/lib/services/groups/wizard.c"));
