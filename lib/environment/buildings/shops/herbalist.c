...
public void Setup()
{
    ...
    addDescriptionTemplate("an herbalist in a wood building");
    addNearDarkDescriptionTemplate("the silhouette of a building");
    addLowLightDescriptionTemplate("the silhouette of a one-story building");
    addDimLightDescriptionTemplate("a dark, possibly wood one-story building");
    addSomeLightDescriptionTemplate("a two-story wood building");
}
