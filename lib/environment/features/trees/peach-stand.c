...
public void Setup()
{
    ...
    addAlias("peach");
    addAlias("peaches");
    addAlias("stand of peaches");
    addAlias("trees");
    addAlias("tree");
    addAlias("peach tree");
    addAlias("peach trees");

    addDescriptionTemplate("a stand of ##Adjective## peach trees");
    addItemTemplate("The stand of peaches is composed of several "
        "medium-sized, productive trees with smooth bark. Their "
        "branches spread gracefully, forming a pleasant canopy "
        "overhead. In season, fuzzy peaches hang from the branches, "
        "and the air is filled with the sweet scent of ripening fruit. "
    ...
    harvestableResource("peach tree", 25, 
        "/lib/instances/items/materials/wood/peach.c",
