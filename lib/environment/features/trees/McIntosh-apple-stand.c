...
public void Setup()
{
    ...
    addAlias("mcintosh apple");
    addAlias("mcintosh apples");
    addAlias("stand of mcintosh apples");
    addAlias("apple");
    addAlias("apples");
    addAlias("trees");
    addAlias("tree");
    addAlias("mcintosh apple tree");
    addAlias("mcintosh apple trees");
    addAlias("apple tree");
    addAlias("apple trees");

    addDescriptionTemplate("a stand of ##Adjective## McIntosh apple trees");
    addItemTemplate("The stand of McIntosh apples is composed of several "
    ...
    harvestableResource("mcintosh apple tree", 25, 
        "/lib/instances/items/materials/wood/apple.c",
        "a heavily-forested stand of McIntosh apple trees. Several "
