...
public void Setup()
{
    ...
    addItemTemplate("The stand of plums is composed of several "
        "medium-sized, productive trees with smooth bark. Their "
        "branches spread gracefully, forming a pleasant canopy "
        "overhead. In season, purple and red plums hang from the "
    ...
    harvestableResource("plum tree", 25, 
        "/lib/instances/items/materials/wood/plum.c",
