...
public void Setup()
{
    ...
    addAlias("green apple");
    addAlias("green apples");
    addAlias("stand of green apples");
    addAlias("apple");
    addAlias("apples");
    addAlias("trees");
    addAlias("tree");
    addAlias("green apple tree");
    addAlias("green apple trees");
    addAlias("apple tree");
    addAlias("apple trees");

    addDescriptionTemplate("a stand of ##Adjective## green apple trees");
    addItemTemplate("The stand of green apples is composed of several "
        "sturdy-trunked, productive trees. Their bark is smooth and "
        "grayish-brown, and their branches spread wide, forming a "
        "pleasant canopy overhead. In season, crisp green apples hang "
        "from the branches, and the air is filled with the tart scent "
    ...
    harvestableResource("green apple tree", 25, 
        "/lib/instances/items/materials/wood/apple.c",
        "a heavily-forested stand of green apple trees. Several trees "
