...
public void Setup()
{
    ...
    addItemTemplate("The stand of maples is composed of several "
        "thick-trunked, stately trees. Their bark is grayish-brown "
        "and deeply grooved, and their branches spread wide, forming "
        "a dense canopy overhead. In season, winged samaras hang from "
        "the branches, and the air is filled with the sweet scent of "
        "maple sap. Moss and lichen cling to the roots, and the "
        "filtered light creates shifting patterns on the forest floor. "
        "Occasionally, you spot a bird or squirrel darting among the "
        "branches.");

    harvestableResource("maple", 25, 
