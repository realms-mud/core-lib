...
public void Setup()
{
    ...
    addItemTemplate("The stand of cherries is composed of several "
        "medium-sized, productive trees with smooth, reddish-brown "
        "bark. Their branches spread gracefully, forming a pleasant "
        "canopy overhead. In season, bright red cherries hang from the "
    ...
    harvestableResource("cherry tree", 25, 
