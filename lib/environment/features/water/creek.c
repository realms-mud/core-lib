...
public void Setup()
{
    ...
    addDescriptionTemplate("a ##Adjective## creek");
    addItemTemplate("The creek flows steadily along its course, its "
        ...
        "The creek's path winds naturally through the landscape, "
