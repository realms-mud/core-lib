...
public void Setup()
{
    ...
    addAdjectives(({ "derelict room with crumbling walls",
        ...
        "room. Small piles of debris has fallen from what were once "
    ...
    addLowLightDescriptionTemplate("a dark chamber. Little detail can be made out in the extremely low light");
