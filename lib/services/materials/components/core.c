...
#include "/lib/services/materials/drinks.h"
#include "/lib/services/materials/enchantments.h"
#include "/lib/services/materials/food.h"
#include "/lib/services/materials/instruments.h"
#include "/lib/services/materials/materials.h"
#include "/lib/services/materials/potions.h"
...
protected nosave string *validDamageTypes = ({ "slash", "bludgeon", "thrust",
    "arrow", "bolt", "bullet" });
protected nosave object configuration = getService("configuration");
...
public nomask int isValidMaterialType(string materialType)
{
    return (member(({ "wood", "textile", "stone", "leather", "metal", 
        "crystal", "skeletal", "plumage", "ore"}), materialType) > -1);
}
