...
//*****************************************************************************
#include "/lib/services/regions/building-layouts.h"
#include "/lib/services/regions/floor-plans.h"
#include "/lib/services/regions/map-icons.h"
#include "/lib/services/regions/region-types.h"
#include "/lib/services/regions/settlements.h"
...
private nomask string *generateEncounters(string regionType, mapping encounters)
{
    ...
    mapping personas = personaService->personaBlueprints();
