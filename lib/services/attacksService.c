...
private string AttacksDir = "/lib/services/attacks";
private string AttackBlueprint = "/lib/services/attacks/baseAttack.c";
    ...
    mapping digestData)
{
    ...
    message = getService("configuration")->decorate(
