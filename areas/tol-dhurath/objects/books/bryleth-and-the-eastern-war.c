...
protected void Setup()
{
    ...
    addChapter("The Shadow of Utumnadh",
        ...
        "'Strike as one! Let the enemy see the banners of unity and dread,' they roared.\n"
        "The battle raged like storm and fire.\n"
    ...
    addChapter("The Rise of Lonisiach",
        ...
        "'No darkness shall claim this land while my blood flows in the veins of men,' Bregandil swore.\n"
