...
public void Setup()
{
    ...
    // Third test
    addExit("west", "/areas/tol-dhurath/temple-interior/pedestal-1x3.c", "third test");
    addExit("south", "/areas/tol-dhurath/temple-interior/pedestal-2x4.c", "third test");
    addDecorator("ruined interior amethyst floor west south", "third test");

    // Fourth test
    addExit("west", "/areas/tol-dhurath/temple-interior/pedestal-1x2.c", "fourth test");
    addExit("east", "/areas/tol-dhurath/temple-interior/pedestal-1x4.c", "fourth test");
    addDecorator("ruined interior amethyst floor west east", "fourth test");

    // Poem complete (final passage)
    addExit("east", "/areas/tol-dhurath/temple-interior/pedestal-1x5.c", "poem complete");
    addExit("south", "/areas/tol-dhurath/temple-interior/pedestal-2x4.c", "poem complete");
