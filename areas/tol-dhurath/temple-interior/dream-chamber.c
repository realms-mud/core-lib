...
public void Setup()
{
    ...
    // Fifth test
    addExit("west", "/areas/tol-dhurath/temple-interior/pedestal-3x5.c", "fifth test");
    addExit("east", "/areas/tol-dhurath/temple-interior/pedestal-1x1.c", "sixth test");

    addObject("/areas/tol-dhurath/objects/dream-pool.c", "fifth test");
