...
public void Setup()
{
    ...
    // Fifth test
    addExit("east", "/areas/tol-dhurath/temple-interior/pedestal-5x3.c", "fifth test");
    addExit("west", "/areas/tol-dhurath/temple-interior/pedestal-5x1.c", "fifth test");
    addDecorator("ruined interior amethyst floor west east", "fifth test");

    // Sixth test
    addExit("north", "/areas/tol-dhurath/temple-interior/pedestal-4x2.c", "sixth test");
    addExit("east", "/areas/tol-dhurath/temple-interior/pedestal-5x3.c", "sixth test");
    addDecorator("ruined interior amethyst floor east north", "sixth test");

    // Poem complete (final passage)
    addExit("east", "/areas/tol-dhurath/temple-interior/pedestal-5x3.c", "poem complete");
    addExit("west", "/areas/tol-dhurath/temple-interior/pedestal-5x1.c", "poem complete");
