...
public void Setup()
{
    ...
    addBuilding("/lib/environment/buildings/military/gate-house.c",
        "south", "/areas/eledhel/southern-city/12x1.c");
    ...
    addExit("north", "/areas/eledhel/southern-city/12x3.c");
    addExit("west", "/areas/eledhel/southern-city/11x2.c");
    addExit("east", "/areas/eledhel/southern-city/13x2.c");
}
