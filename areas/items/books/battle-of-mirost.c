...
protected void Setup()
{
    ...
    addChapter("Argloth Awakens the Dead",
        ...
        "Kuarl's diary fragment reads: 'I feel them, the old stones tremble\n"
        "with my fury.' Knights charged, steel against corrupted steel,\n"
        "dwarves cleaving through shadows. The air was thick with smoke,\n"
        "blood, and the smell of death. A knight fell, eyes glowing red;\n"
        "undead claimed him instantly. Kuarl: 'I have slain friends, yet\n"
        "they rise again. My hammer feels too weak.'\n"
        ...
        "Kuarl: 'The beast mocks me; I swing, I strike, yet the stone beneath\n"
        "shakes.' Knights held line; dwarves threw axes, severing limbs yet\n"
        "more rose. Argloth scrawled in a diary: 'All is becoming clearer.\n"
        "Power is mine to command.' Every step forward was bought with\n"
        "sweat, blood, and tears.\n"
        "Kuarl: 'I pray to Dhuran, to stone, to anything that hears us.'\n"
        ...
        "Kuarl's hands shook, yet he swung again, taking down one of the\n"
        "walking dead. The battle was a blur of metal, shadow, and\n"
        "unrelenting terror.");
