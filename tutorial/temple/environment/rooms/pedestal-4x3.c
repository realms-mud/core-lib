...
public void Setup()
{
    ...
    addExit("south", "/tutorial/temple/environment/rooms/pedestal-5x3.c", "poem complete");
    addExit("west", "/tutorial/temple/environment/rooms/pedestal-4x2.c", "poem complete");
