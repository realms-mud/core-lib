...
public void Setup()
{
    ...
    addExit("north", "/tutorial/temple/environment/rooms/pedestal-1x4.c", "poem complete");
    addExit("south", "/tutorial/temple/environment/rooms/pedestal-3x4.c", "poem complete");
