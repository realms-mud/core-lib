...
public void Setup()
{
    ...
    addExit("east", "/tutorial/temple/environment/rooms/pedestal-5x3.c", "poem complete");
    addExit("west", "/tutorial/temple/environment/rooms/pedestal-5x1.c", "poem complete");
