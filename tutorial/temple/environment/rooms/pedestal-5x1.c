...
public void Setup()
{
    ...
    addExit("north", "/tutorial/temple/environment/rooms/pedestal-4x1.c", "poem complete");
    addExit("east", "/tutorial/temple/environment/rooms/pedestal-5x2.c", "poem complete");
