...
public void Setup()
{
    ...
    addExit("east", "/tutorial/temple/environment/rooms/pedestal-4x3.c", "poem complete");
    addExit("north", "/tutorial/temple/environment/rooms/pedestal-3x2.c", "poem complete");
