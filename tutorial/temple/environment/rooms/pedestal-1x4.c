...
public void Setup()
{
    ...
    addExit("east", "/tutorial/temple/environment/rooms/pedestal-1x5.c", "poem complete");
    addExit("south", "/tutorial/temple/environment/rooms/pedestal-2x4.c", "poem complete");
