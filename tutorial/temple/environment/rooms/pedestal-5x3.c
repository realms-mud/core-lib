...
public void Setup()
{
    ...
    addExit("north", "/tutorial/temple/environment/rooms/pedestal-4x3.c", "poem complete");
    addExit("west", "/tutorial/temple/environment/rooms/pedestal-5x2.c", "poem complete");
