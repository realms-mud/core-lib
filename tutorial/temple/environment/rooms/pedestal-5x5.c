...
public void Setup()
{
    ...
    addExit("north", "/tutorial/temple/environment/rooms/pedestal-4x5.c", "poem complete");
    addExit("south", "/tutorial/temple/environment/rooms/chamber-of-kings.c", "poem complete");
