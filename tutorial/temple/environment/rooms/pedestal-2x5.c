...
public void Setup()
{
    ...
    addExit("north", "/tutorial/temple/environment/rooms/pedestal-1x5.c", "poem complete");
    addExit("south", "/tutorial/temple/environment/rooms/pedestal-3x5.c", "poem complete");
