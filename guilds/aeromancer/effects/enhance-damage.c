...
{
    addSpecification("name", "Enhance Damage");
    addSpecification("source", "aeromancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the aeromancer spell construction component for enhancing "
        "damage output.");

    addPrerequisite("/guilds/aeromancer/effects/enhance-attack.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "aeromancerEnhanceDamageEvent");
}
