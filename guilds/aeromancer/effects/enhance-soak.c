...
{
    addSpecification("name", "Enhance Soak");
    addSpecification("source", "aeromancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the aeromancer spell construction component for enhancing "
        "damage absorption.");

    addPrerequisite("/guilds/aeromancer/effects/enhance-defense.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "aeromancerEnhanceSoakEvent");
}
