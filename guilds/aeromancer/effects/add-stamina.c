...
{
    addSpecification("name", "Add Stamina Points");
    addSpecification("source", "aeromancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the aeromancer spell construction component for restoring "
        "stamina points.");

    addPrerequisite("/guilds/aeromancer/effects/add-sp.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "aeromancerAddStaminaPointsEvent");
}
