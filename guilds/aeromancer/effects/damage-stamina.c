...
{
    addSpecification("name", "Damage Stamina Points");
    addSpecification("source", "aeromancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the aeromancer spell construction component for damaging "
        "stamina points.");

    addPrerequisite("/guilds/aeromancer/effects/damage-sp.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "aeromancerDamageStaminaPointsEvent");
}
