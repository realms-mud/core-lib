...
{
    addSpecification("name", "Siphon Stamina Points");
    addSpecification("source", "aeromancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the aeromancer spell construction component for vampirically "
        "taking stamina points from a foe and transferring a portion to the caster.");

    addPrerequisite("/guilds/aeromancer/effects/siphon-sp.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "aeromancerSiphonStaminaPointsEvent");
}
