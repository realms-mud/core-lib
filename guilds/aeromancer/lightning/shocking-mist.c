...
{
    addSpecification("name", "Shocking Mist");
    addSpecification("source", "aeromancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the shocking mist spell. By means of this, the "
        "aeromancer releases an electricity-laced fog. Any enemy caught in "
    ...
    addSpecification("event handler", "shockingMistEvent");
    addSpecification("command template", "shocking mist");
    addSpecification("use ability message",  "##InitiatorName## "
        "##Infinitive::utter## words of power and a fog laced with "
        "tiny bolts of electricity coursing through it fills the area.");
}
