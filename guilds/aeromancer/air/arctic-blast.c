...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the arctic blast spell. The aeromancer reaches into the "
        "upper atmosphere to draw down a surge of frigid air, flash-freezing "
        "moisture in the air as it races toward the target. The intense cold "
        "bites deep, chilling flesh and numbing muscles.");
    ...
    addSpecification("use ability message", "A blast of freezing, arctic wind "
        ...
        "slams into ##TargetName## with a force of icy fury.");
}
