...
{
    addSpecification("name", "Whirling Wind");
    addSpecification("source", "aeromancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the whirling wind spell. The aeromancer becomes the axis "
        "of a massive horizontal cyclone, spinning winds of incredible force "
        "that sweep across the entire battlefield. The attack strikes multiple "
    ...
    addSpecification("event handler", "whirlingWindEvent");
    addSpecification("command template", "whirling wind");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::spin## and ##Infinitive::unleash## a devastating "
        "whirlwind that tears through the area.");
    addSpecification("repeated ability message", "The whirling wind continues "
        "to batter ##InitiatorPossessive::Name## foes with relentless fury.");
}
