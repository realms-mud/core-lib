...
{
    addSpecification("name", "Choking Wind");
    addSpecification("source", "aeromancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the choking wind spell. The aeromancer creates a "
        "sustained pocket of thin, oxygen-depleted air around a target's head. "
        "Unable to draw breath, the victim weakens rapidly as their body "
    ...
    addSpecification("event handler", "chokingWindEvent");
    addSpecification("command template", "choking wind [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::gesture## and the air around ##TargetName## becomes "
        "thin and suffocating, choking the breath from ##TargetPossessive## lungs.");
}
