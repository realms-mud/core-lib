...
{
    addSpecification("name", "Daggers of the Wind");
    addSpecification("source", "aeromancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the daggers of the wind spell. The aeromancer shapes "
        "dozens of small, incredibly sharp wind blades and launches them in "
        "a deadly barrage at a single target. Each dagger strikes with "
        "precision, and the rapid succession of impacts overwhelms defenses.");

    addPrerequisite("/guilds/aeromancer/air/jetstream.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "daggersOfTheWindEvent");
    addSpecification("command template", "daggers of the wind [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::conjure## a storm of razor-sharp wind blades that "
        "hurtle toward ##TargetName##.");
    addSpecification("repeated ability message", "More wind daggers slice "
        "through ##TargetName##.");
}
