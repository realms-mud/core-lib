...
protected void Setup()
{
    ...
    addSpecification("event handler", "vortexEvent");
    addSpecification("command template", "vortex [at ##Target##]");
    addSpecification("use ability message", "A swirling vortex of wind "
        "engulfs ##TargetName##, battering and disorienting ##TargetObjective##.");
}
