...
{
    addSpecification("name", "Foul Gasp");
    addSpecification("source", "aeromancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the foul gasp spell. The aeromancer forces a concentrated "
        "bubble of utterly dead air directly into a target's lungs. The victim "
        "experiences immediate oxygen deprivation, their body convulsing as it "
        "desperately tries to expel the toxic void. The effects are devastating "
        "and long-lasting.");

    addPrerequisite("/guilds/aeromancer/air/choking-wind.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "foulGaspEvent");
    addSpecification("command template", "foul gasp [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::thrust## ##InitiatorPossessive## palm toward "
        "##TargetName##, forcing a burst of toxic air into "
        "##TargetPossessive## lungs.");
}
