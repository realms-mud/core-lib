...
public void SetupGuild()
{
    ...
    addCriteria("fire", ([
        "type": "research tree",
        "apply": "at level 1",
        "research tree": "/guilds/pyromancer/fire.c"
    ]));

    addCriteria("flame", ([
        "type": "research tree",
        "apply": "at level 1",
        "research tree": "/guilds/pyromancer/flame.c"
    ]));

    addCriteria("forms", ([
        "type": "research tree",
        "apply": "at level 1",
        "research tree": "/guilds/pyromancer/forms.c"
    ]));

    addCriteria("functions", ([
        "type": "research tree",
        "apply": "at level 1",
        "research tree": "/guilds/pyromancer/functions.c"
    ]));

    addCriteria("effects", ([
        "type": "research tree",
        "apply": "at level 1",
        "research tree": "/guilds/pyromancer/effects.c"
    ]));

    addCriteria("construct", ([
        "type": "research tree",
        "apply": "at level 1",
        "research tree": "/guilds/pyromancer/construct.c"
    ]));
}
