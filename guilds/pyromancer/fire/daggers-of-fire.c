...
{
    addSpecification("name", "Daggers of Fire");
    addSpecification("source", "pyromancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the daggers of fire spell. The pyromancer conjures "
    ...
    addSpecification("event handler", "daggersOfFireEvent");
    addSpecification("command template", "daggers of fire [at ##Target##]");
    addSpecification("use ability message", "Blazing daggers of fire impale "
        "##TargetName## as ##InitiatorName## ##Infinitive::gesture##.");
}
