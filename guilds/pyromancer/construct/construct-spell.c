...
{
    addSpecification("name", "Construct Pyromancer Spell");
    ...
    addSpecification("command template", "construct pyromancer spell");
}
    ...
    string researchName)
{
    ...
    selectorObj.setType("Pyromancer Spell");
    selectorObj.setConstructedGrouping("/guilds/pyromancer/construct/root.c");
