...
{
    addSpecification("name", "Blazing Swarm");
    addSpecification("source", "pyromancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the blazing swarm spell. By means of this, the "
        "pyromancer conjures a swarm of burning projectiles that devastate "
        "all nearby foes.");
    ...
    addSpecification("event handler", "blazingSwarmEvent");
    addSpecification("command template", "blazing swarm");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::summon## a blazing swarm of fiery projectiles that "
