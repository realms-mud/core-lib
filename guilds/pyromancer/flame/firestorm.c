...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the firestorm spell. By means of this, the "
        "pyromancer conjures a devastating storm of flame that burns all "
        "nearby foes.");
    ...
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::summon## a devastating firestorm that burns "
        "everything nearby.");
}
