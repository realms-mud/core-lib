...
{
    addSpecification("name", "Flame Damage");
    addSpecification("source", "pyromancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of creating spells that damage targets with burning flames.");
    ...
    addSpecification("combination descriptor", "burning flame");
}
