...
protected void Setup()
{
    ...
    addSpecification("description", "This skill provides the user with an "
        "impregnable mental fortress, making them nearly immune to psychic "
        "attacks and mental manipulation.");
    ...
    addPrerequisite("/guilds/oneiromancer/nightmare-persona/lord-of-fears.c",
        (["type":"research"]));
