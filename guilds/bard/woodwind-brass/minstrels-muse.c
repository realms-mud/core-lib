...
{
    addSpecification("name", "Minstrel's Muse");
    ...
    addPrerequisite("guilds/bard/woodwind-brass/majestys-mephit.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "museMephitEvent");
    addSpecification("use composite message", "##InitiatorName## "
        "##Infinitive::trill## a ##CompositeSegment## on "
