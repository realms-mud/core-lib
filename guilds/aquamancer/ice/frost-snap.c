...
{
    addSpecification("name", "Frost Snap");
    addSpecification("source", "aquamancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the frost snap spell. By means of this, the "
    ...
    addSpecification("event handler", "frostSnapEvent");
    addSpecification("command template", "frost snap [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::snap## ##InitiatorPossessive## fingers and a "
        "burst of intense cold strikes ##TargetName##.");
}
