...
{
    addSpecification("name", "Raging Blizzard");
    addSpecification("source", "aquamancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the raging blizzard spell. By means of this, the "
        "aquamancer unleashes an apocalyptic blizzard that devastates all "
        "foes in the area with extreme cold and cutting ice.");

    addPrerequisite("/guilds/aquamancer/ice/hailstorm.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "ragingBlizzardEvent");
    addSpecification("command template", "raging blizzard");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::unleash## a raging blizzard of apocalyptic fury "
        "that engulfs the area in ice and snow.");
}
