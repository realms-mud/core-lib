...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of creating spells that form an expanding ring of water "
    ...
    addSpecification("use combination message", 
        "##InitiatorName## ##Infinitive::release## an expanding ring of ##Function## that slams into ##TargetName##.");
}
