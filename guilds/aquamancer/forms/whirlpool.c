...
{
    addSpecification("name", "Whirlpool Form");
    addSpecification("source", "aquamancer");

    addSpecification("description", "This research provides the user with the "
        "knowledge of creating spells that form a spinning whirlpool of "
    ...
    addSpecification("use combination message", 
        "##InitiatorName## ##Infinitive::summon## a whirlpool of ##Function## that engulfs ##TargetName##.");
}
