...
{
    addSpecification("name", "Great Maelstrom");
    addSpecification("source", "aquamancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the great maelstrom spell. The aquamancer summons an "
        "enormous vortex of churning water that dwarfs their earlier attempts. "
    ...
    addSpecification("event handler", "greatMaelstromEvent");
    addSpecification("command template", "great maelstrom");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::summon## an enormous maelstrom that engulfs the area, "
        "crushing all foes in its devastating depths.");
}
