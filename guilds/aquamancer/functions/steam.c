...
{
    addSpecification("name", "Steam Damage");
    addSpecification("source", "aquamancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of creating spells that damage targets with scalding "
    ...
    addSpecification("combination descriptor", "scalding steam");
}
