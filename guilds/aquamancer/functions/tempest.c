...
{
    addSpecification("name", "Tempest Damage");
    addSpecification("source", "aquamancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of creating spells that damage targets with the combined "
    ...
    addSpecification("combination descriptor", "tempest fury");
}
