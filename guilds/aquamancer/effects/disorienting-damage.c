...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the aquamancer spell construction component for dealing "
        "damage that disorients the target, temporarily reducing their "
        "evasion capabilities.");

    addPrerequisite("/guilds/aquamancer/effects/reduce-parry.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "aquamancerDisorientingDamageEvent");
}
