...
{
    addSpecification("name", "Reduce Attack");
    addSpecification("source", "aquamancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the aquamancer spell construction component for reducing "
        "a target's attack capabilities.");

    addPrerequisite("/guilds/aquamancer/effects/damage-hp.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "aquamancerReduceAttackEvent");
}
