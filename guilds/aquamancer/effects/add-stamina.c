...
{
    addSpecification("name", "Add Stamina");
    addSpecification("source", "aquamancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the aquamancer spell construction component for restoring "
        "stamina points.");

    addPrerequisite("/guilds/aquamancer/effects/add-sp.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "aquamancerAddStaminaEvent");
}
