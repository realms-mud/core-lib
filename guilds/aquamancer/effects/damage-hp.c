...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the aquamancer spell construction component for damaging "
        "hit points.");

    addPrerequisite("/guilds/aquamancer/effects/root.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "aquamancerDamageHitPointsEvent");
}