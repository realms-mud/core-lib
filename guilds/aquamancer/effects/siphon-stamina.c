...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the aquamancer spell construction component for vampirically "
        "taking stamina from a foe and transferring a portion to the caster.");

    addPrerequisite("/guilds/aquamancer/effects/siphon-sp.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "aquamancerSiphonStaminaEvent");
}
