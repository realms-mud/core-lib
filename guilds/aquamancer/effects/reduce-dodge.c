...
{
    addSpecification("name", "Reduce Dodge");
    addSpecification("source", "aquamancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the aquamancer spell construction component for reducing "
        "a target's evasion capabilities.");

    addPrerequisite("/guilds/aquamancer/effects/reduce-soak.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "aquamancerReduceDodgeEvent");
}
