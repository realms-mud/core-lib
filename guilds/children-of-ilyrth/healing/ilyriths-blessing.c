...
{
    addSpecification("name", "Ilyrith's Blessing");
    ...
    addSpecification("event handler", "ilyrithsBlessingEvent");
    addSpecification("command template", "ilyriths blessing [at ##Target##]");
