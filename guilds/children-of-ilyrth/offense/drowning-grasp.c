...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the drowning grasp spell. The caster conjures water "
    ...
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::conjure## a sphere of churning water that engulfs "
        "##TargetName##, crushing and suffocating ##TargetObjective##.");
}
