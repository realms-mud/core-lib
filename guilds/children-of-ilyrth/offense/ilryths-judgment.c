...
{
    addSpecification("name", "Ilryth's Judgment");
    addSpecification("source", "Children of Ilyrth");
    addSpecification("description", "This research provides the user with the "
        "knowledge of Ilryth's judgment spell. The caster becomes a conduit "
    ...
    addSpecification("event handler", "ilrythsJudgmentEvent");
    addSpecification("command template", "ilryth's judgment [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::channel## the divine wrath of Ilyrth as a pillar of "
        "radiant water crashes down upon ##TargetName##.");
}
