...
public void reset(int arg)
{
    if (!arg)
    {
        ...
        addSpecification("description", "This research provides the user with the "
            ...
            "dagger that encapsulates them in a protective barrier. Doing so "
        ...
        addSpecification("modifiers", ({ 
            ([
                "type":"research",
                "research item": "lib/guilds/scion/paths/dagger/electricity/static-shield.c",
                "name" : "static shield",
                "formula" : "additive",
                "base value" : 5,
                "rate": 1.0
            ...
            ([
                "type":"research",
                "research item": "lib/guilds/scion/paths/dagger/electricity/plasma-shield.c",
                "name" : "plasma shield",
                "formula" : "additive",
                "base value" : 5,
                "rate": 1.0
