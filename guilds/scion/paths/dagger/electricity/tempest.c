...
public void reset(int arg)
{
    if (!arg)
    {
        ...
        addSpecification("description", "This research provides the user with the "
            ...
            "Scion is able to use their dagger as a conduit for emitting a "
        ...
        addPrerequisite("lib/guilds/scion/paths/dagger/root.c",
            (["type":"research"]));
        addPrerequisite("lib/guilds/scion/paths/dagger/electricity/shocking-barrier.c",
            (["type":"research"]));
        ...
        addSpecification("modifiers", ({ 
            ([
                "type":"research",
                "research item": "lib/guilds/scion/paths/dagger/electricity/static-barrier.c",
                "name" : "Static Charge",
                "formula" : "additive",
                "base value" : 2,
                "rate": 1.0
            ...
            ([
                "type":"research",
                "research item": "lib/guilds/scion/paths/dagger/electricity/ionized-barrier.c",
                "name" : "Ionization",
                "formula" : "additive",
                "base value" : 2,
                "rate": 1.0
            ...
            ([
                "type":"research",
                "research item": "lib/guilds/scion/paths/dagger/electricity/plasma-barrier.c",
        ...
        addSpecification("use ability message", "A wave of plasma and electricity erupts "
            "from ##InitiatorPossessive::Name## dagger and engulfs "
            "##TargetName##.");
    }
}
