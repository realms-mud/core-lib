...
public void reset(int arg)
{
    if (!arg)
    {
        ...
        addSpecification("description", "This research provides the user with the "
            ...
            "Scion is able to use their dagger as a conduit for sending balls "
        ...
        addPrerequisite("lib/guilds/scion/paths/dagger/root.c",
            (["type":"research"]));
        addPrerequisite("lib/guilds/scion/paths/dagger/electricity/lightning-blast.c",
            (["type":"research"]));
        ...
        addSpecification("use ability message",  "Intense balls of plasma "
            "erupt from ##InitiatorPossessive::Name## dagger.");
    }
}
