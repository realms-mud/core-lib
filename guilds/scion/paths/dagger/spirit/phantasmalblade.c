...
public void reset(int arg)
{
    if (!arg)
    {
        ...
        addSpecification("modifiers", ({ 
            ([
                "type":"research",
                "research item": "lib/guilds/scion/paths/dagger/spirit/sweeping-mist.c",
                "name" : "sweeping mist",
                "formula" : "additive",
                "base value" : 2,
                "rate": 1.0
            ...
            ([
                "type":"research",
                "research item": "lib/guilds/scion/paths/dagger/spirit/phantasmal-brand.c",
            ...
            ([
                "type":"research",
                "research item": "lib/guilds/scion/paths/dagger/spirit/spirit-blade.c",
                "name" : "spirit blade",
                "formula" : "additive",
                "base value" : 2,
                "rate": 1.0
            ...
            ([
                "type":"research",
                "research item": "lib/guilds/scion/paths/dagger/spirit/spirit-edge.c",
                "name" : "spirit edge",
                "formula" : "additive",
                "base value" : 2,
                "rate": 1.0
            ...
            ([
                "type":"research",
                "research item": "lib/guilds/scion/paths/dagger/spirit/nienwyns-pommel.c",
        ...
        addSpecification("use ability activate message", "Thin wisps of pulsating "
            "mist wrap around ##InitiatorPossessive::Name## dagger.");
        addSpecification("use ability deactivate message", "Thin wisps of pulsating "
            "mist around ##InitiatorPossessive::Name## dagger fade away.");
    }
}
