...
public void reset(int arg)
{
    if (!arg)
    {
        ...
        addPrerequisite("lib/guilds/scion/paths/sword/root.c",
            (["type":"research"]));
        addPrerequisite("lib/guilds/scion/paths/flame.c",
            (["type":"research"]));
        ...
        addSpecification("event handler", "flamesEvent");
        addSpecification("command template", "flames [at ##Target##]");
        addSpecification("use ability message",  "Small tongues of deep red fire "
