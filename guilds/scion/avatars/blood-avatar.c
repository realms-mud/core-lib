...
{
    addResearchElement("guilds/scion/avatars/blood/touch-of-the-damned.c");

    addChild("guilds/scion/avatars/blood/touch-of-the-damned.c",
        "guilds/scion/avatars/blood/root.c");
}
...
{
    addResearchElement("guilds/scion/avatars/blood/soul-scourge.c");

    addChild("guilds/scion/avatars/blood/soul-scourge.c",
...
{
    addResearchElement("guilds/scion/avatars/blood/sanguine-spear.c");

    addChild("guilds/scion/avatars/blood/sanguine-spear.c",
...
public void reset(int arg)
{
    if (!arg)
    {
        ...
        Description("This skill tree provides the user with the knowledge "
            "to summon an avatar of blood magic.");
        Source("Scion of Dhuras Guild");
        addResearchElement("guilds/scion/avatars/blood/root.c");
        TreeRoot("guilds/scion/avatars/blood/root.c");
