...
{
    addSpecification("name", "Ice Avatar");
    addSpecification("source", "Scion of Dhuras Guild");

    addSpecification("description", "This skill provides the user with the "
        "knowledge of how to summon an ice avatar.");

    addSpecification("number to summon", 1);
    addSpecification("persona", "scion of ice");
    ...
    addSpecification("modifiers", ([
        ...
        "/guilds/scion/avatars/ice/chill-touch.c":({
            (["modifier": "apply research",
               "value": "/guilds/scion/avatars/ice/chill-touch-spell.c" ]),
        }),
        ...
        "/guilds/scion/avatars/ice/ice-bolt.c":({
            (["modifier": "apply research",
               "value": "/guilds/scion/avatars/ice/ice-bolt-spell.c" ]),
        }),
        ...
        "/guilds/scion/avatars/ice/glacial-blast.c":({
            (["modifier": "apply research",
               "value": "/guilds/scion/avatars/ice/glacial-blast-spell.c" ]),
        }),
    ...
    addSpecification("event handler", "iceAvatarEvent");
    addSpecification("command template", "ice avatar");
