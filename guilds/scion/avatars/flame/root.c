...
public void reset(int arg)
{
    if (!arg)
    {
        ...
        addSpecification("name", "Flame Avatar");
        addSpecification("source", "Scion of Dhuras Guild");

        addSpecification("description", "This skill provides the user with the "
            "knowledge of how to summon a flame avatar.");

        addSpecification("number to summon", 1);
        addSpecification("persona", "scion of fire");
        ...
        addSpecification("modifiers", ([
            ...
            "guilds/scion/avatars/flame/fire-touch.c":({
                (["modifier": "apply research",
                   "value": "guilds/scion/avatars/flame/fire-touch-spell.c" ]),
            }),
            ...
            "guilds/scion/avatars/flame/fire-bolt.c":({
                (["modifier": "apply research",
                   "value": "guilds/scion/avatars/flame/fire-bolt-spell.c" ]),
            }),
            ...
            "guilds/scion/avatars/flame/searing-blast.c":({
                (["modifier": "apply research",
                   "value": "guilds/scion/avatars/flame/searing-blast-spell.c" ]),
            }),
        ...
        addSpecification("event handler", "flameAvatarEvent");
        addSpecification("command template", "flame avatar");
