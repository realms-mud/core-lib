...
{
    addResearchElement("guilds/scion/avatars/evocation/mystic-touch.c");

    addChild("guilds/scion/avatars/evocation/mystic-touch.c",
        "guilds/scion/avatars/evocation/root.c");
}
...
{
    addResearchElement("guilds/scion/avatars/evocation/energy-bolt.c");

    addChild("guilds/scion/avatars/evocation/energy-bolt.c",
...
{
    addResearchElement("guilds/scion/avatars/evocation/kinetic-blast.c");

    addChild("guilds/scion/avatars/evocation/kinetic-blast.c",
...
{
    Name("Evocation Avatar");
    Description("This skill tree provides the user with the knowledge "
        "to summon an avatar of electricity magic.");
    Source("Scion of Dhuras Guild");
    addResearchElement("guilds/scion/avatars/evocation/root.c");
    TreeRoot("guilds/scion/avatars/evocation/root.c");
