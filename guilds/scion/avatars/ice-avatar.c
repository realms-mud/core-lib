...
{
    addResearchElement("/guilds/scion/avatars/ice/chill-touch.c");

    addChild("/guilds/scion/avatars/ice/chill-touch.c",
        "/guilds/scion/avatars/ice/root.c");
}
...
{
    addResearchElement("/guilds/scion/avatars/ice/ice-bolt.c");

    addChild("/guilds/scion/avatars/ice/ice-bolt.c",
...
{
    addResearchElement("/guilds/scion/avatars/ice/glacial-blast.c");

    addChild("/guilds/scion/avatars/ice/glacial-blast.c",
