...
{
    addResearchElement("guilds/scion/avatars/flame/fire-touch.c");

    addChild("guilds/scion/avatars/flame/fire-touch.c",
        "guilds/scion/avatars/flame/root.c");
}
...
{
    addResearchElement("guilds/scion/avatars/flame/fire-bolt.c");

    addChild("guilds/scion/avatars/flame/fire-bolt.c",
        "guilds/scion/avatars/flame/fire-touch.c");
}
...
{
    addResearchElement("guilds/scion/avatars/flame/searing-blast.c");

    addChild("guilds/scion/avatars/flame/searing-blast.c",
        "guilds/scion/avatars/flame/fire-bolt.c");
}
...
public void reset(int arg)
{
    if (!arg)
    {
        ...
        Description("This skill tree provides the user with the knowledge "
            "to summon an avatar of fire magic.");
        Source("Scion of Dhuras Guild");
        addResearchElement("guilds/scion/avatars/flame/root.c");
        TreeRoot("guilds/scion/avatars/flame/root.c");
