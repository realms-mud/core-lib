...
{
    addSpecification("name", "Scion of Blood");
    addSpecification("source", "Scion of Dhuras Guild");

    addSpecification("description", "This skill provides the user with the "
        "knowledge of how to summon a blood avatar.");
    ...
    addSpecification("event handler", "bloodAvatarEvent");
    addSpecification("command template", "blood avatar");
