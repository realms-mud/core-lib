...
{
    addSpecification("name", "Scion of Electricity");
    addSpecification("source", "Scion of Dhuras");

    addSpecification("description", "This skill provides the user with the "
        "knowledge of how to summon an electricity avatar.");

    addSpecification("number to summon", 1);
    addSpecification("persona", "scion of electricity");
    ...
    addSpecification("modifiers", ([
        ...
        "/guilds/scion/avatars/electricity/shock-touch.c":({
            (["modifier": "apply research",
               "value": "/guilds/scion/avatars/electricity/shock-touch-spell.c" ]),
        }),
        ...
        "/guilds/scion/avatars/electricity/lightning.c":({
            (["modifier": "apply research",
               "value": "/guilds/scion/avatars/electricity/lightning.c" ]),
        }),
        "/guilds/scion/avatars/common/extra-attack.c":({
            (["modifier": "bonus electricity attack",
               "value": 15 ]),
        }),
        ...
        "/guilds/scion/avatars/electricity/plasma-bolt.c":({
            (["modifier": "apply research",
               "value": "/guilds/scion/avatars/electricity/plasma-bolt-spell.c" ]),
        }),
    ...
    addSpecification("event handler", "electricityAvatarEvent");
    addSpecification("command template", "electricity avatar");
