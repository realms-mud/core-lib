...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the geomancer spell construction component for enfeebling "
        "a target, weakening their physical capabilities.");

    addPrerequisite("/guilds/geomancer/effects/apply-slow.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "geomancerApplyEnfeebledEvent");
}
