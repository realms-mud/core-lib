...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the geomancer spell construction component for siphoning "
        "life force from a target while invigorating the caster with enhanced "
        "speed.");
    ...
    addSpecification("event handler", "geomancerInvigoratingSiphonEvent");
}
