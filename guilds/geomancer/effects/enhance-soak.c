...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the geomancer spell construction component for enhancing "
        "damage absorption.");

    addPrerequisite("/guilds/geomancer/effects/enhance-defense.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "geomancerEnhanceSoakEvent");
}
