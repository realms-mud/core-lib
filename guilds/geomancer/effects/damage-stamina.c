...
{
    addSpecification("name", "Damage Stamina");
    addSpecification("source", "geomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the geomancer spell construction component for damaging "
        "stamina points.");

    addPrerequisite("/guilds/geomancer/effects/damage-sp.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "geomancerDamageStaminaEvent");
}
