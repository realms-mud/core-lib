...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the geomancer spell construction component for restoring "
        "stamina points.");

    addPrerequisite("/guilds/geomancer/effects/add-sp.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "geomancerAddStaminaEvent");
}
