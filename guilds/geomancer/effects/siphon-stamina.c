...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the geomancer spell construction component for vampirically "
        "taking stamina from a foe and transferring a portion to the caster.");

    addPrerequisite("/guilds/geomancer/effects/siphon-sp.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "geomancerSiphonStaminaEvent");
}
