...
{
    addSpecification("name", "Pebble");
    addSpecification("source", "geomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the pebble spell. By means of this, the "
    ...
    addSpecification("event handler", "pebbleEvent");
    addSpecification("command template", "pebble [at ##Target##]");
    addSpecification("use ability message", "A magically-propelled stone "
        "flies from ##InitiatorPossessive::Name## "
