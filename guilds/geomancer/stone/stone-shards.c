...
{
    addSpecification("name", "Stone Shards");
    addSpecification("source", "geomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the stone shards spell. By means of this, the "
    ...
    addSpecification("event handler", "stoneShardsEvent");
    addSpecification("command template", "stone shards [at ##Target##]");
    addSpecification("use ability message", "Razor-sharp shards of stone "
        "fly from ##InitiatorPossessive::Name## outstretched hand into "
        "##TargetName##.");
}
