...
{
    addSpecification("name", "Entombing Damage");
    addSpecification("source", "geomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of creating spells that damage targets by partially "
    ...
    addSpecification("combination descriptor", "entombing stone");
}
