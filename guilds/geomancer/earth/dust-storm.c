...
{
    addSpecification("name", "Dust Storm");
    addSpecification("source", "geomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the dust storm spell. The geomancer conjures a violent "
    ...
    addSpecification("event handler", "dustStormEvent");
    addSpecification("command template", "dust storm");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::summon## a violent dust storm that scours the area.");
}
