...
{
    addSpecification("name", "Stalagmite");
    addSpecification("source", "geomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the stalagmite spell. The geomancer causes a massive "
    ...
    addSpecification("event handler", "stalagmiteEvent");
    addSpecification("command template", "stalagmite [at ##Target##]");
    addSpecification("use ability message", "A massive spike of stone erupts "
