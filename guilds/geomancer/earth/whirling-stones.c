...
{
    addSpecification("name", "Whirling Stones");
    addSpecification("source", "geomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the whirling stones spell. The geomancer conjures a "
    ...
    addSpecification("event handler", "whirlingStonesEvent");
    addSpecification("command template", "whirling stones");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::conjure## a devastating tornado of whirling stones "
        "that tears through the area.");
}
