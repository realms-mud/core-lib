...
{
    addSpecification("name", "Empyrean Ward");
    addSpecification("source", "therianthrope");
    addSpecification("description", "Your feathers take on an empyrean "
        "quality, granting exceptional protection against all forms of "
        "damage.");
