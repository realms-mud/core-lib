...
{
    addSpecification("name", "Pounce");
    addSpecification("source", "therianthrope");
    addSpecification("description", "While in panther form, you leap at your "
        "target with explosive speed, striking with claws extended.");
    addSpecification("usage summary", "A lunging claw attack only usable "
        "while in panther form");

    addPrerequisite("/guilds/therianthrope/panther/razor-claws.c",
        (["type":"research"]));
    ...
    addSpecification("cooldown modifiers", ([
        "/guilds/therianthrope/panther/blinding-speed.c": 1,
    ]));
    ...
    addSpecification("command template", "pounce [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::launch## through the air at ##TargetName##, claws "
        "extended in a lightning-fast pounce!");
}
