...
protected void Setup()
{
    ...
    addSpecification("event handler", "alagosEvent");
    addSpecification("command template", "alagos [at ##Target##]");
    addSpecification("use ability message",  "##InitiatorPossessive::Name## "
        "##Infinitive::gesture## ##InitiatorPossessive## "
        "##InitiatorWeapon## at ##TargetName## sending a hurricane-forced gale their way.");
    addSpecification("use combination message", "##Infinitive::summon## "
        "a hurricane-forced gale");
}
