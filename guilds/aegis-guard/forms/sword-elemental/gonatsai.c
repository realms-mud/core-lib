...
protected void Setup()
{
    ...
    addPrerequisite("guilds/aegis-guard/forms/sword-elemental/ambar.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "gonatsaiEvent");
    addSpecification("command template", "gonatsai [at ##Target##]");
    addSpecification("use ability message",  "##InitiatorPossessive::Name## "
        "##Infinitive::gesture## ##InitiatorPossessive## "
        "##InitiatorWeapon## at ##TargetName## sending crystaline javelins their way.");
    addSpecification("use combination message", "##Infinitive::summon## "
        "a hail of crystaline javelins");
}
