...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/aegis-guard/forms/sword-elemental/naurtho.c",
        (["type":"research"]));
    ...
    addSpecification("event handler", "lhachaEvent");
    addSpecification("command template", "lhacha [at ##Target##]");
    addSpecification("use ability message",  "##InitiatorPossessive::Name## "
        "##Infinitive::gesture## ##InitiatorPossessive## "
        "##InitiatorWeapon## at ##TargetName## sending a maelstrom of flames their way.");
