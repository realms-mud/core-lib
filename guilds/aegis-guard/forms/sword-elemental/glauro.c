...
{
    addSpecification("name", "Glauro");
    addSpecification("source", "Aegis Guard");
    addSpecification("description", "This research provides the user with the "
        "knowledge of a technique that allows one to project a blast of electrical "
        "energy known to the Aegis Guard as glauro. "
    ...
    addSpecification("event handler", "glauroEvent");
    addSpecification("command template", "glauro [at ##Target##]");
    addSpecification("use ability message",  "##InitiatorPossessive::Name## "
        "##Infinitive::gesture## ##InitiatorPossessive## "
        "##InitiatorWeapon## at ##TargetName## sending tendrils of lightning their way.");
