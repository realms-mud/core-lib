...
{
    addSpecification("name", "Pilin ai Heleg");
    addSpecification("source", "Aegis Guard");
    addSpecification("description", "This research provides the user with the "
        "knowledge to set an arrow to magical ice as it flies from a bow.");
    ...
    addSpecification("event handler", "pilinAiHelegEvent");
    addSpecification("command template", "pilin ai heleg [at ##Target##]");
    addSpecification("use ability message",  "##InitiatorPossessive::Name## "
        "##Infinitive::aim## ##InitiatorPossessive## "
        "##InitiatorWeapon## at ##TargetName## and "
        "##Infinitive::intone## 'Pilin ai heleg!' The head of the arrow "
        "glows with a frigid white aura as it flies into ##TargetName##.");
}
