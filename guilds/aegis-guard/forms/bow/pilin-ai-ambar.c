...
{
    addSpecification("name", "Pilin ai Ambar");
    ...
    addSpecification("event handler", "pilinAiAmbarEvent");
    addSpecification("command template", "pilin ai ambar [at ##Target##]");
    addSpecification("use ability message",  "##InitiatorPossessive::Name## "
        "##Infinitive::aim## ##InitiatorPossessive## "
        "##InitiatorWeapon## at ##TargetName## and "
        "##Infinitive::intone## 'Pilin ai ambar!' The head of the arrow "
        "looks like stone and takes on a grey aura as it flies into ##TargetName##.");
}
