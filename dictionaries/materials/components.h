...
([
    "Type X": ([
        "class": "blade",
        "description": "This is a broad, medium length blade with a lenticular cross-section. "
    ...
    "Type XI": ([
        "class": "blade",
        "description": "This is a medium length blade with a lenticular cross-section. "
            "The fuller is narrow and runs almost the entire length of the blade, ending in a "
            "sharp, acute point."
    ]),
    "Type XIa": ([
        "class": "blade",
        "description": "This is a broad, evenly tapered tapered, medium length blade with a lenticular cross-section. "
            "The fuller is narrow and runs almost the entire length of the blade, ending in a "
            "sharp, acute point."
    ]),
    "Type XIIa": ([
        "class": "blade",
        "description": "This is a broad, flat, and evenly tapered blade with a lenticular cross-section. "
            "The fuller is narrow and runs 2/3 of the length of the blade, ending in a "
            "sharp, acute point."
    ]),
    "Type XIII": ([
        "class": "blade",
        "description": "This is a broad, flat, blade with parallel edges and a "
            "lenticular cross-section. The fuller is narrow and runs half of "
            "the length of the blade, ending in a rounded point."
    ]),
    "Type XIV": ([
        "class": "blade",
        "description": "This is a broad, flat, sharply tapering blade with a "
            "lenticular cross-section. The fuller is narrow and runs 3/4 of "
            "the length of the blade, ending in a sharp, acute point."
    ]),
    "Type XV": ([
        "class": "blade",
        "description": "This is a broad, sharply tapering blade with a "
            "flattened diamond cross-section and no fuller. "
            "The blade ends in a sharp, acute point."
    ]),
    "Type XVa": ([
        "class": "blade",
        "description": "This is a slender, strongly tapering blade with a "
            "flattened diamond cross-section and no fuller. "
            "The blade ends in a sharp, acute point."
    ]),
    "Type XVI": ([
    ...
    "Type XVI": ([
        "class": "blade",
        "description": "This is a broad, slowly tapering blade with a "
            "flattened hexagonal cross-section. The fuller is narrow and runs 1/3 of "
            "the length of the blade, ending in a sharp, acute point."
    ]),
    "Type XVII": ([
        "class": "blade",
        "description": "This is a slender, acutely tapering blade with a "
            "narrow and stout hexagonal cross-section. The fuller is shallow and runs 1/4 of "
            "the length of the blade, ending in a sharp, acute point."
    ]),
    "Type XVIII": ([
        "class": "blade",
        "description": "This is a very broad, gracefully tapering blade with a "
            "flattened diamond cross-section. The fuller is shallow and runs 1/4 of "
            "the length of the blade, ending in a sharp, acute point."
    ]),
    "Type XVIIIa": ([
        "class": "blade",
        "description": "This is a slender, gracefully tapering blade with a "
            "flattened diamond cross-section. The fuller is shallow and runs 1/4 of "
            "the length of the blade, ending in a sharp, acute point."
    ]),
    "Type XVIIIb": ([
    ...
    "Type XVIIIc": ([
        "class": "blade",
        "description": "This is a broad, gracefully tapering blade with a "
            "flattened diamond cross-section. The fuller is shallow and runs 1/4 of "
    ...
    "Type XVIIIe": ([
        "class": "blade",
        "description": "This is a long blade with a flattened diamond "
    ...
    "Type XIX": ([
        "class": "blade",
        "description": "This is a long blade with a flattened hexagonal "
    ...
    "Type XX": ([
        "class": "blade",
        "description": "This is a broad blade with nearly parallel edges that "
    ...
    "Type XXII": ([
        "class": "blade",
        "description": "This is a broad, flat blade gracefully tapers. It has "
    ...
    "Flamberge": ([
        "class": "blade",
        "description": "This is a broad, flat, blade with parallel, undulating "
